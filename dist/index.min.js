...
const environment=config.environment||'development'; const createGethClient=memoization_1.memoize(function(a){return new GethClient_1(a)}); const createProvider=memoization_1.memoize(providerFactory);function createSonmFactory(a,b,c={}){const d=add0x(b),e=createProvider(a),f=createGethClient(e),g={address0x:d,gethClient:f,config:config[environment]};return Object.assign(g,c),{createAccount:async function(){const a=new Account_1(g);return await a.addToken(config[environment].contractAddress.token),a},createTxResult:function(a){return new TransactionResult(a,f)},setPrivateKey:function(a){const b=add0x(a);e.setPrivateKey(b);}}}var blockchainApiJs={createSonmFactory,utils:{recoverPrivateKey}};
